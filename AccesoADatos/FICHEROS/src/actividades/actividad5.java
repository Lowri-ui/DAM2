...
línea de comandos. Los contenidos del fichero se leen en bloques de 32 bytes, y el contenido de cada bloque se escribe en una línea de texto.
...
public class actividad5 {
     ...
     */
    public void volcar(PrintStream salida) throws IOException {
        ...
        do {
            ...
            // Imprime el offset actual formateado a 5 dígitos mediante PrintStream, y no System.out .
    ...
    public static void main(String[] args) {
        ...
        String nombreSalida = "volcado.txt"; // nombre del archivo de salida

        // Usa un 'try-with-resources' para asegurar que el 'FileInputStream' se cierra automáticamente.
        try (FileInputStream fis = new FileInputStream(nomFich);PrintStream ps = new PrintStream(new FileOutputStream(nombreSalida))) {
            // Crea una instancia de 'VolcadoBinario' pasando el 'FileInputStream'.
            actividad5 vb = new actividad5(fis);
