...
/**
 * ACTIVIDAD 3.1
 * Modifica el programa del ejemplo DOMParser.java para que escriba la salida a
 * un fichero con nombre parsing_dom.txt. Como mejora, puedes utilizar la clase
 * SimpleDateFormat para hacer que en el nombre de fichero se incluyan la fecha
 * y la hora, de manera similar a como se hacía en un programa de ejemplo del
 * capítulo anterior dedicado a ficheros.
 */
...
public class actividad3_1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            db.setErrorHandler(new actividades.GestorEventos3());
            ...
            ps.close(); //Para cerrar el fichero
            System.out.println("Fichero XML: " + nombreSalida);
 ...
 */
class GestorEventos4 extends DefaultHandler {
